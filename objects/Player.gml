...
var _draw_x, _draw_y, _draw_xprevious, _draw_yprevious, _draw_sprite, _draw_alpha, _draw_color, _draw_yscale;

// Round draw coordinates to prevent jitter.
_draw_x = floor(x + 0.5);
_draw_y = floor(y + 0.5);
_draw_xprevious = floor(xprevious + 0.5);
_draw_yprevious = floor(yprevious + 0.5);
